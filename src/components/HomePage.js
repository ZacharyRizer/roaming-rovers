    ...
    <ResponsiveContext.Consumer>
      {(size) =>
        size !== 'small' ? (
          <Box fill direction="row" align="center" justify="evenly">
            <Box direction="column" alignSelf="start" margin="medium">
              ...
              <Paragraph color="color4">
                ...
                rovers, Opportunity, Spirit, and Curiosity. The twins, Spirit
                and Opportunity, landed in 2004, and Curiosity joined them on
                the red planet in 2012. Between the three, thousands of images
                have been sent back from Mars.
              </Paragraph>
              <Paragraph color="color4">
                Utilizing NASA's Mars Rover Photos API, this site explores
                Earth's neighbor right alongside Curiosity, Spirit, and
                Opportunity. Click above to see what they saw, and to learn more
                about the Rover's themselves!
              </Paragraph>
            </Box>
            <Box
              flex={false}
              ...
              <Carousel fill color="color1" play={4000}>
                ...
                <Image
                  fit="cover"
                  src="/images/Opportunity/Opportunity11.jpg"
                />
          ...
          <Box fill direction="column" align="center" justify="evenly">
            ...
            <Paragraph color="color4" margin="small">
